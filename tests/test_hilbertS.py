...
def test_hilbertS_close():
    ...
    th.intro("habc")
    log_state("after intro habc")

    th.intro("hab")
    log_state("after intro hab")

    th.intro("ha")
    log_state("after intro ha")

    th.apply("habc")
    log_state("after apply habc")

    th.exact("ha")
    log_state("after exact ha")

    th.apply("hab")
    log_state("after apply hab")
